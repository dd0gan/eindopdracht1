...
import { isAdminUser, getCurrentUser, isUser } from "../../auth/authUtil";
                    ...
                    <div>
                        {
                            this.isApplied(row) ?
                                ...
                                this.isClosed(row) ?
                                    ...
                                    :
                                    <Button type="button" variant="success" onClick={(e) => this.handleApplyButton(e, row.id)}>Apply</Button>
                        }
                        {
                            isAdminUser() &&
                            <Button type="button" variant="primary" onClick={(e) => {this.handleEditButton(e, row.id)}} style={{marginLeft: 5}}>Edit</Button>
                        }
                        {
                            isAdminUser() &&
                            <Button type="button" variant="info" onClick={(e) => {this.handleReviewButton(e, row.id)}} style={{marginLeft: 5}}>Review</Button>
                        }
                    </div>
                )
            },
                    ...
                    <Row>
                        <Col>
                            <section className="text-left">
                                <Button type="button" variant="primary" onClick={this.handleAddButton}>Add</Button>
                            </section>
                        </Col>
                    </Row>
                }
